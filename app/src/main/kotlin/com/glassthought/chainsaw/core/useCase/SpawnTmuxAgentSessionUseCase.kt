package com.glassthought.chainsaw.core.useCase
...
import com.glassthought.chainsaw.core.agent.TmuxAgentSession
...
class SpawnTmuxAgentSessionUseCase(
  ...
  outFactory: OutFactory,
     ...
     * the resulting [com.glassthought.chainsaw.core.agent.TmuxAgentSession].
     *
     * @param request Contains the phase type and working directory for the agent.
     * @return A [com.glassthought.chainsaw.core.agent.TmuxAgentSession] with a live tmux session and resolved session identity.
