...
# Build the binary distribution before E2E tests.
...
./gradlew :app:test -PrunIntegTests=true --tests "com.glassthought.shepherd.integtest.e2e.StraightforwardWorkflowE2EIntegTest" 2>&1 | tee .tmp/test_with_e2e.txt
