...
import com.glassthought.shepherd.core.agent.starter.AgentStarter
 ...
 *
 * Always includes `--dangerously-skip-permissions` because TICKET_SHEPHERD is guaranteed
 * to run inside a Docker container (enforced by [com.glassthought.shepherd.core.initializer.EnvironmentValidator]
 * at startup, ref.ap.A8WqG9oplNTpsW7YqoIyX.E).
 *
 * @param handshakeGuid The [HandshakeGuid] generated by the harness for this session.
 *   Exported as [Constants.AGENT_COMM.HANDSHAKE_GUID_ENV_VAR] before launching claude so
 *   callback scripts can include it in every HTTP callback.
...
class ClaudeCodeAgentStarter(
    private val handshakeGuid: HandshakeGuid,
    ...
    override fun buildStartCommand(): TmuxStartCommand {
        ...
        val innerCommand = "cd $workingDir && " +
            "unset CLAUDECODE && " +
