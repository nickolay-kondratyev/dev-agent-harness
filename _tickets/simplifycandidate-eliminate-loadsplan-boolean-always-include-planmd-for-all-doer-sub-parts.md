---
closed_iso: 2026-03-17T23:29:23Z
...
status_updated_iso: 2026-03-17T23:29:23Z
type: task
priority: 3
...
**2026-03-17T23:29:23Z**

Resolved. Removed loadsPlan from all spec files:
- doc/schema/plan-and-current-state.md: removed SubPart field row, updated examples and table note
- doc/core/ContextForAgentProvider.md: updated PlanMd description, removed loadsPlan requirement from Planner instructions
- doc/use-case/SetupPlanUseCase/DetailedPlanningUseCase.md: removed validation step c, re-lettered remaining steps
- doc/schema/ai-out-directory.md: updated PLAN.md description and comparison table

PLAN.md is now always included for all doer sub-parts in with-planning workflows. No conditional logic needed.
