...
Let's add it under `./app/src/main/kotlin/com/glassthought/shepherd/core/initializer/data`
...
```kt file=[$(git.repo_root)/app/src/main/kotlin/com/glassthought/shepherd/core/initializer/Initializer.kt] Lines=[58-58]
